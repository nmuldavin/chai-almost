...
var almostEqual = function almostEqual(left, right, tol) {
  return left + tol >= right && left - tol <= right;
};
...
var chaiAlmost = function chaiAlmost() {
  ...
  return function (_ref, _ref2) {
    ...
    function method(expected) {
      ...
      new Assertion(this._obj).to.be.closeTo(expected, customTolerance);
    }

    function chainingBehavior() {
      var customTolerance = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : standardTolerance;
